...
execute if score #arcane_core.internal:time.day_time.hours arcane_core.api.math matches 0.. \
	if score #arcane_core.internal:time.day_time.minutes arcane_core.api.math matches 0.. \
...
scoreboard players operation #arcane_core.internal:time.day_time.hours arcane_core.api.math = #arcane_core.internal:time.day_time.ticks arcane_core.api.math
