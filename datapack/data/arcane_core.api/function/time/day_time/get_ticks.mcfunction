...
#
# @output
# 	score #arcane_core.api:out.time.day_time.ticks arcane_core.api.math
...
scoreboard players operation #arcane_core.api:out.time.day_time.ticks arcane_core.api.math = #arcane_core.internal:time.day_time.ticks arcane_core.api.math
