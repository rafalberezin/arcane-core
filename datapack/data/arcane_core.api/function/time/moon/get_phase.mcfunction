...
#
# @output
#	score #arcane_core.api:time.moon.phase arcane_core.api.math
# 		The current moon phase (1-8).

execute if score #arcane_core.internal:time.moon.phase arcane_core.api.math matches 0.. \
	run return run scoreboard players operation #arcane_core.api:time.moon.phase arcane_core.api.math = #arcane_core.api:time.moon.phase arcane_core.api.math
...
scoreboard players operation #arcane_core.api:time.moon.phase arcane_core.api.math = #arcane_core.internal:time.moon.phase arcane_core.api.math
