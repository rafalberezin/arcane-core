...
# @api
#
# @output score #arcane_core.api:time/moon/phase arcane_core.math moon phase

execute if score #arcane_core.internal:time.moon.phase arcane_core.math matches 0.. run scoreboard players operation #arcane_core.api:time.moon.phase arcane_core.math = #arcane_core.internal:time.moon.phase arcane_core.math
