...
execute store success score #arcane_core.internal:temp arcane_core.state run function arcane_core.internal:module/item/update/modify_item with storage arcane_core.internal:temp root.macro
