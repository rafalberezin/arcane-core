...
execute if score #arcane_core.internal:error arcane_core.state = #arcane_core.internal:error.ok arcane_core.state \
	run return run data modify storage arcane_core.internal:temp /.phase.register_project.success_blob append from storage arcane_core.internal:temp /.text_blob[]

data modify storage arcane_core.internal:temp /.phase.register_project.warning_blob append from storage arcane_core.internal:temp /.text_blob[]
return 0
