...
execute if data storage arcane_core.internal:temp /.load_phase.projects.success_blob[0] \
	run function arcane_core.internal:data/load_report/compose/add_success_section

execute if data storage arcane_core.internal:temp /.load_phase.projects.warning_blob[0] \
...
data remove storage arcane_core.internal:temp /.load_phase.projects
