...
scoreboard players operation #arcane_core.internal:error arcane_core.api.state = #arcane_core.internal:error.register_project.incompatible_version arcane_core.api.state

execute store result score #arcane_core.internal:temp.major arcane_core.api.state run data get storage arcane_core.internal:temp /.phase.register_project.project.core_version[0]
execute store result score #arcane_core.internal:temp.minor arcane_core.api.state run data get storage arcane_core.internal:temp /.phase.register_project.project.core_version[1]
execute store result score #arcane_core.internal:temp.patch arcane_core.api.state run data get storage arcane_core.internal:temp /.phase.register_project.project.core_version[2]
