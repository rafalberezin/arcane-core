...
scoreboard players set #arcane_core.internal:module.item.valid_cache arcane_core.state 1
...
execute unless score #arcane_core.internal:module.item.valid_cache arcane_core.state matches 1 \
